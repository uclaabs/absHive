...
public class CondMergeEvaluator extends GenericUDAFEvaluatorWithInstruction {
  ...
  private static ListObjectInspector longMatrixOI = ObjectInspectorFactory.getStandardListObjectInspector(CondList.longListOI);
  private static ListObjectInspector doubleMatrixOI = ObjectInspectorFactory.getStandardListObjectInspector(CondList.doubleMatrixOI);
  private static List<String> columnName = Arrays.asList("Keys", "Ranges");
  private static List<ObjectInspector> ObjectInspectorType = Arrays.asList((ObjectInspector)longMatrixOI, (ObjectInspector) doubleMatrixOI);
  private static StructObjectInspector partialOI = ObjectInspectorFactory.getStandardStructObjectInspector(columnName, ObjectInspectorType);
  ...
  private static class MyAggregationBuffer implements AggregationBuffer {
    ...
    public MyAggregationBuffer(ObjectInspector rangeValOI, ListObjectInspector rangeList) {
  ...
  public AggregationBuffer getNewAggregationBuffer() throws HiveException {
    return new MyAggregationBuffer(this.rangeValueOI, this.rangeListOI);
  }
