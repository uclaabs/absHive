...
public class SrvAvgEvaluator extends SrvSumEvaluator {
  ...
  protected final List<String> avgColumnName = Arrays.asList("BaseSum","BaseSsum", "BaseCnt", "Group");
  protected final List<ObjectInspector> avgObjectInspectorType = Arrays.asList((ObjectInspector)doubleOI, (ObjectInspector)doubleOI, (ObjectInspector)intOI, (ObjectInspector)partialGroupOI);
  protected final StructObjectInspector avgPartialOI = ObjectInspectorFactory.getStandardStructObjectInspector(avgColumnName, avgObjectInspectorType);
