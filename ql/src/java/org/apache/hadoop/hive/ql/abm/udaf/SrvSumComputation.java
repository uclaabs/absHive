...
public class SrvSumComputation extends UDAFComputation {
  ...
  private DoubleArrayList result = new DoubleArrayList();
  private List<DoubleArrayList> doubleMatrix = new ArrayList<DoubleArrayList>();
  private DoubleArrayList currentList = new DoubleArrayList();
  private double baseSum = 0;
  private double baseSsum = 0;
  private int N = 0;
  private int groupCnt = -1;
  
  private double currentSum = 0;
  private double currentSsum = 0;
  private double confidenceLower = 0;
  private double confidenceUpper = 0;
  ...
  private void addDistribution(double sum, double ssum) {
  ...
  private void unfoldSrvList(int level, double sum, double ssum) {
